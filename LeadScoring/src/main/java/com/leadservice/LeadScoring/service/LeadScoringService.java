...
//        for (Lead lead : leads) {
//            int ruleScore = calculateRuleScore(lead, offer);
//            int aiScore = getAiScoreFromOpenAI(lead, offer);
//
//            int finalScore = ruleScore + aiScore;
//            String intent = getIntent(finalScore);
//
...
//    }
//
//    private int getAiScoreFromOpenAI(Lead lead, Offer offer) {
//        String prompt = """
...
//        """.formatted(
//                offer.getName(), offer.getValueProps(), offer.getIdealUseCases(),
//                lead.getName(), lead.getRole(), lead.getCompany(),
//                lead.getIndustry(), lead.getLocation(), lead.getLinkedinBio()
//        );
//
...
//
//                    if (content.toLowerCase().contains("high")) return 50;
//                    if (content.toLowerCase().contains("medium")) return 30;
//                    return 10;
//                }
//            } catch (Exception e) {
//                System.out.println("AI scoring error (attempt " + attempt + "): " + e.getMessage());
//                try {
//                    Thread.sleep(attempt * 1000L); // exponential backoff (1s, 2s, 3s)
//                } catch (InterruptedException ignored) {}
//            }
//        }
//        return 30; // fallback if all retries fail
//    }
//
